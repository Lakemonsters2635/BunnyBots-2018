...
public class CameraServerFPS {
  ...
  private static CameraServerFPS server;

  /**
   * Get the CameraServer instance.
   */
  public static synchronized CameraServerFPS getInstance() {
    if (server == null) {
      server = new CameraServerFPS();
    }
    return server;
  }
  ...
  public CvSource putVideo(String name, int width, int height) {
	CvSource source = new CvSource(name, VideoMode.PixelFormat.kMJPEG, width, height, 1);
